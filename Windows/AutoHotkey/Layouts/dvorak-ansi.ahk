 ...
 * License     : MIT
 *
 * This script implements the Dvorak layout by intercepting the scan codes
 * sent by the physical keyboard and remapping them to the Dvorak layout's
 * key positions.
 *
 ...
 *   character output while maintaining the physical Dvorak position.
 *
 ...
 *      | Tab | ' | , | . | P | Y | F | G | C | R | L | / | = | \   |
 *      |-----',--',--',--',--',--',--',--',--',--',--',--',--'-----|
 *      |CapsLk| A | O | E | U | I | D | H | T | N | S | - | Enter  |
 *      |------'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'--------|
