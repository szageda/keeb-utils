...
; scripts and hotkeys. It can also be used to detect the scan code of a
; non-standard keyboard key.
...
;; -------- Keeb Utils to Load --------------------------------------------- ;;
; Enable or disable features by commenting (disable) or uncommenting (enable)
; the lines below.
;; ------------------------------------------------------------------------- ;;
