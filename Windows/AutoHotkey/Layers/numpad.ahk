 ...
 * License     : MIT
 *
 * This script implements a dedicated Numpad Layer. This layer is a "stepped"
 * configuration: Hold Left Alt to access the Symbols layer (symbols.ahk),
 * then hold Caps Lock to activate the Numpad Layer. It provides a 3x3 numeric
 * grid, hexadecimal characters, and mathematical operators for technical
 * data entry.
 *
